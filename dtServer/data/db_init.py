...
def init_user_center_member() : 
    list_data = open_data_file_csv('./data/test_data/user_center_member.csv')
    userCenterMemberDao.insert_many(list_data) 
