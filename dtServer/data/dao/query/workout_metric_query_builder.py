...
class WorkoutMatricQueryBuilder : 
    ...
    def make_select_query() : 
        q = WorkoutMetrics.select( 
                                ...
                                WorkoutSet.id.alias('set_id'), WorkoutSet.set, WorkoutSet.weight, WorkoutSet.total_reps, WorkoutSet.set_start_time, WorkoutSet.set_end_time, WorkoutSet.res_start_time, WorkoutSet.res_end_time,                                
