...
class WorkoutReportDTO : 
    ...
    def __init__(self, total_workout_time, total_lifting_time, total_sets, total_volume, total_reps, avg_reps_pet_set, avg_weight,  set_reports : list[WorkoutSetReportDTO] ) : 
